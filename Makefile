# This Makefile is for the Number::Spell extension to perl.
#
...
PM_TO_BLIB = problem17.pl \
	$(INST_LIB)/Number/problem17.pl \
	problem9.pl \
	$(INST_LIB)/Number/problem9.pl \
	problem5.pl \
	$(INST_LIB)/Number/problem5.pl \
	problem8.pl \
	$(INST_LIB)/Number/problem8.pl \
	problem13.pl \
	$(INST_LIB)/Number/problem13.pl \
	problem14.pl \
	$(INST_LIB)/Number/problem14.pl \
	problem4.pl \
	$(INST_LIB)/Number/problem4.pl \
	problem11.pl \
	$(INST_LIB)/Number/problem11.pl \
	problem12.pl \
	$(INST_LIB)/Number/problem12.pl \
	problem15.pl \
	$(INST_LIB)/Number/problem15.pl \
	problem6.pl \
	$(INST_LIB)/Number/problem6.pl \
	problem16.pl \
	$(INST_LIB)/Number/problem16.pl \
	Spell.pm \
	$(INST_LIB)/Number/Spell.pm \
	problem7.pl \
	$(INST_LIB)/Number/problem7.pl \
	problem10.pl \
	$(INST_LIB)/Number/problem10.pl
...
DISTNAME = Number-Spell
DISTVNAME = Number-Spell-0.04
...
# Number::Spell might depend on some other libraries:
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  Spell.pm $(INST_MAN3DIR)/Number::Spell.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               Number-Spell' >> META_new.yml
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  problem17.pl $(INST_LIB)/Number/problem17.pl \
	  problem9.pl $(INST_LIB)/Number/problem9.pl \
	  problem5.pl $(INST_LIB)/Number/problem5.pl \
	  problem8.pl $(INST_LIB)/Number/problem8.pl \
	  problem13.pl $(INST_LIB)/Number/problem13.pl \
	  problem14.pl $(INST_LIB)/Number/problem14.pl \
	  problem4.pl $(INST_LIB)/Number/problem4.pl \
	  problem11.pl $(INST_LIB)/Number/problem11.pl \
	  problem12.pl $(INST_LIB)/Number/problem12.pl \
	  problem15.pl $(INST_LIB)/Number/problem15.pl \
	  problem6.pl $(INST_LIB)/Number/problem6.pl \
	  problem16.pl $(INST_LIB)/Number/problem16.pl \
	  Spell.pm $(INST_LIB)/Number/Spell.pm \
	  problem7.pl $(INST_LIB)/Number/problem7.pl \
	  problem10.pl $(INST_LIB)/Number/problem10.pl 
